...
import pix1 from "../assets/c837a6_f8d49ec34c8a4f95890362cc7a53f89b~mv2.jpeg";
import pix2 from "../assets/c837a6_8ea5cc0a06664ef6a3c1cf64e1cb5a27~mv2.jpeg";
import pix3 from "../assets/c837a6_ce32dd298b274ba280efa267e075be21~mv2.jpeg";
import pix4 from "../assets/c837a6_2308b08ad22c4e4aa919906536a1b5d1~mv2.jpeg";
import pix5 from "../assets/wix image1.webp";
      ...
      <div className="w-full h-full  flex gap-3">
        <div className="w-[15%] h-full ">
          <div className="flex gap-2 items-center ml-12 mt-5 mb-7 cursor-pointer">
            ...
            <p className="font-light">New Drops</p>
          </div>
        ...
        <div className="w-[80%] h-full">
          <div className="mt-20 mb-5">
            <h1 className="font-black text-[50px]">New Drops</h1>
          </div>
          ...
          <div className="w-full h-[55vh] mb-7">
            <div className="w-full h-full flex justify-between">
              ...
              <div className="w-[23%] h-full ">
                ...
                <div className="w-full h-[15%] ">
                  <p className="mt-1 font-light v">i'm a product</p>
                  <p className="font-light text-[12px]">$15.00</p>
                </div>
              </div>
              <div className="w-[23%] h-full ">
